...
import { ChargingConfidencePanel } from './charging-confidence';

export function StationEvidence({ station, info, fetchedAt }: { station: Station; info: AvailabilityInfo; fetchedAt: string }) {
  return <><ChargingConfidencePanel info={info} /><section className="evidence-panel" aria-label="Data freshness">
