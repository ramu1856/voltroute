...
export default function Terms(){
 return <main className="legal-page"><div className="legal-shell"><a href={WORKER_SITE_URL}>← Back to VoltRoutes</a><h1>Terms of Use</h1><p>Last updated: September 19, 2026</p>
